    ...
    <div>
      ...
      <div style={{ fontSize: "0.85em" }} className="ficha-hero">
        <HeroBannerPlanes
          ...
          title="Imagen de <span style='color: #4D32A5;'>Marca</span>"
          content="Diseña la identidad visual única de tu marca que te diferencie de la competencia y resuene con tu audiencia."
