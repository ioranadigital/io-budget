        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Spa & Bienestar</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Restaurante</a></li>
